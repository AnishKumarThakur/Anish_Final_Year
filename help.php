    ...
    <section class="about py-5">
        <div class="container py-md-5">
            <div class="about-w3ls-info mx-auto">
                <h3 class="tittle-wthree pt-md-5 pt-3 text-center">Question and Answers</h3>
                ...
                <p class="sub-tittle mt-3 mb-sm-5 mb-4">
                  ...
                  <p class="h6">A: Customer who chip their orders within 5 km from store should expect their orders within 1-2 days. But who are outside the range should their order 
                ...
                <p class="sub-tittle mt-3 mb-sm-5 mb-4">
                  ...
                  <p class="h6">A: There are our staffs for delivering your product.</p>
                </p><hr>
                <p class="sub-tittle mt-3 mb-sm-5 mb-4">
                  <p class="h4">Q: What is the delivery charge?</p>
                  <p class="h6">A: The exact rate of delivery charge is Rs. 500.</p>
                </p><hr>
                <p class="sub-tittle mt-3 mb-sm-5 mb-4">
