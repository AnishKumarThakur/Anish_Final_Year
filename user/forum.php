...
<head>
	...
	<title>Forum | Hosanna Furnitures</title>
                        ...
                        <div class="card">
                            ...
                            <div class="content">
                                <form action="../actions/postQuestion-action.php" method="POST">
                                    ...
                                    <button type="submit" class="btn btn-info btn-fill pull-right" name="postQuestion">Post</button>
                            ...
                            <div class="card">
                                ...
                                <div class="content">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <h5>Ques: <?php echo $data['question']; ?></h5>
                                            ...
                                            <form class="comment-form" action="../actions/forumComments-action.php" method="POST">
                                                ...
                                                <input class="btn" type="submit" name="postComments" value="Submit">
                                            </form>
                                        </div>
                                    </div>
                                </div>
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <p class="copyright pull-right">
                    &copy; <script>document.write(new Date().getFullYear())</script> Hosanna Furnitures
                </p>
            </div>
        </footer>
